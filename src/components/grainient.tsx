...
export default function Grainient({
  ...
  useEffect(() => {
    ...
    if (!renderer.isWebgl2) {
      console.warn("[Grainient] WebGL2 é necessário para este efeito.");
      return;
    }
    ...
    return () => {
      ...
      // Não chamar WEBGL_lose_context aqui: em navegação client-side (ex.: logout → /login)
      // alguns browsers deixam de criar um novo contexto de forma fiável até recarregar a página.
    };
  }, [
    timeSpeed,
    colorBalance,
