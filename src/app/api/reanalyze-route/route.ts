...
- "diagnosticScores.comment": **exatamente 2 parágrafos curtos** com \\n\\n; meta **total ~260–480 caracteres** (teto rígido ~520); **no máximo 2 frases curtas por parágrafo**; 1º = fato/evidência do tópico; 2º = uma prioridade ou passo claro. **Cada parágrafo termina com frase completa** (`.` `!` ou `?`); **proibido** `...` ou `…` ou frase cortada. Sem clichês nem repetir o mesmo contraste em todos. Se a nota for < 10, o que falta para 10/10 **no máximo uma vez**.
